...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        $this->MultiCell(0, 15, 'Work Oder Request', 0, 'C', 0, 1, 10, '', true);
...
$pdf->SetTitle('Work Order Request');
...
$html = '<table border="1px">
                                        <tr>
                                            <th>
                                                <table>
                                                    <tr>
                                                        <th width="150px"><br><br>Work Order Request No</th>
                                                        <th width="180px"><br><br>: '.$row->no_wor.'</th>
                                            ...
                                            <th>
                                                <table>
                                                    <tr>
                                                        ...
                                                        <th width="180px"><br><br>: '.$row->wor_desc.'<br></th>
                                                    </tr>
                                                </table>
                                            </th>
                                        </tr>
                                            ...
                                            <th>
                                                <table>
                                                    <tr>
                                                        ...
                                                        <th width="180px"><br><br>: '.$row->couse_desc.'<br></th>
                                                    </tr>
                                                </table>
                                            </th>
                                        </tr>
